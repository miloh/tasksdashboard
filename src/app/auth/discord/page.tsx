    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-900 via-secondary-900 to-secondary-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white/10 backdrop-blur-md rounded-3xl p-8 shadow-2xl">
        <div className="text-center space-y-6">
          ...
          <button
            onClick={handleLogin}
            className="w-full bg-gradient-to-r from-secondary-600 via-brand-600 to-accent-600 hover:from-brand-900 hover:via-brand-600 hover:to-accent-600 text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-3"
          >
